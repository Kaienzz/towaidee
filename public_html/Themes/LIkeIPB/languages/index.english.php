...
$forum_copyright = '<a href="%3$s?action=credits" title="License" target="_blank" rel="noopener">%1$s &copy; %2$s</a>';
...
// Additional language keys for sidebar
$txt['hello_member_ndt'] = 'Hello';
$txt['registered'] = 'Registered';
$txt['quick_navigation'] = 'Quick Navigation';
